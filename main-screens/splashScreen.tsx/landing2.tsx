...
const SplashScreen2 = (props: Props) => {
  return (
    <View style={tw` bg-[#2E2E2E] p-4`}>
      ...
      <View style={tw`text-center items-center justify-around`}>
        <Text style={tw`font-semibold text-[26px] text-white w-[80%] text-center`}>Set Reminders for your medicine</Text>
      </View>
      <View style={tw`text-center items-center`}>
        <Image source={require('../../assets/images/screen2.png')} style={tw`text-center items-center `} />
      </View>
      <View style={tw`text-center items-center`}>
